...
.dlls,em4 .dlls: water_monitor.pem4

-include package/cfg/water_monitor_pem4.mak
-include package/cfg/water_monitor_pem4.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/water_monitor_pem4.dep
endif
water_monitor.pem4: package/cfg/water_monitor_pem4.xdl
	@


ifeq (,$(wildcard .libraries,em4))
water_monitor.pem4 package/cfg/water_monitor_pem4.c: .libraries,em4
endif

package/cfg/water_monitor_pem4.c package/cfg/water_monitor_pem4.h package/cfg/water_monitor_pem4.xdl: override _PROG_NAME := water_monitor.xem4
package/cfg/water_monitor_pem4.c: package/cfg/water_monitor_pem4.cfg
package/cfg/water_monitor_pem4.xdc.inc: package/cfg/water_monitor_pem4.xdl
package/cfg/water_monitor_pem4.xdl package/cfg/water_monitor_pem4.c: .interfaces

clean:: clean,em4
	-$(RM) package/cfg/water_monitor_pem4.cfg
	-$(RM) package/cfg/water_monitor_pem4.dep
	-$(RM) package/cfg/water_monitor_pem4.c
	-$(RM) package/cfg/water_monitor_pem4.xdc.inc

clean,em4::
	-$(RM) water_monitor.pem4
.executables,em4 .executables: water_monitor.xem4

water_monitor.xem4: |water_monitor.pem4

-include package/cfg/water_monitor.xem4.mak
water_monitor.xem4: package/cfg/water_monitor_pem4.oem4 
	$(RM) $@
	@$(MSG) lnkem4 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/water_monitor_pem4.oem4   package/cfg/water_monitor_pem4.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4.rootDir)/lib/libc.a
	
water_monitor.xem4: export C_DIR=
water_monitor.xem4: PATH:=$(ti.targets.arm.elf.M4.rootDir)/bin/;$(PATH)
water_monitor.xem4: Path:=$(ti.targets.arm.elf.M4.rootDir)/bin/;$(PATH)

water_monitor.test test,em4 test: water_monitor.xem4.test

water_monitor.xem4.test:: water_monitor.xem4
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 water_monitor.xem4.test
else
	@$(MSG) running $<  ...
	$(call EXEC.water_monitor.xem4, ) 
endif

clean,em4::
	-$(RM) $(wildcard .tmp,water_monitor.xem4,*)


clean:: clean,em4

clean,em4::
	-$(RM) water_monitor.xem4
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
water_monitor_pem4.oem4,copy : package/cfg/water_monitor_pem4.oem4
water_monitor_pem4.sem4,copy : package/cfg/water_monitor_pem4.sem4

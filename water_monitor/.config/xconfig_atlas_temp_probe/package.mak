...
override PKGDIR = xconfig_atlas_temp_probe
...
ti.targets.arm.elf.M4.rootDir ?= C:/ti/ccs930/ccs/tools/compiler/ti-cgt-arm_18.12.4.LTS
...
package/%.xdc.inc package/%_xconfig_atlas_temp_probe.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_atlas_temp_probe" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4 .dlls: atlas_temp_probe.pem4

-include package/cfg/atlas_temp_probe_pem4.mak
-include package/cfg/atlas_temp_probe_pem4.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/atlas_temp_probe_pem4.dep
endif
atlas_temp_probe.pem4: package/cfg/atlas_temp_probe_pem4.xdl
	@


ifeq (,$(wildcard .libraries,em4))
atlas_temp_probe.pem4 package/cfg/atlas_temp_probe_pem4.c: .libraries,em4
endif

package/cfg/atlas_temp_probe_pem4.c package/cfg/atlas_temp_probe_pem4.h package/cfg/atlas_temp_probe_pem4.xdl: override _PROG_NAME := atlas_temp_probe.xem4
package/cfg/atlas_temp_probe_pem4.c: package/cfg/atlas_temp_probe_pem4.cfg
package/cfg/atlas_temp_probe_pem4.xdc.inc: package/cfg/atlas_temp_probe_pem4.xdl
package/cfg/atlas_temp_probe_pem4.xdl package/cfg/atlas_temp_probe_pem4.c: .interfaces

clean:: clean,em4
	-$(RM) package/cfg/atlas_temp_probe_pem4.cfg
	-$(RM) package/cfg/atlas_temp_probe_pem4.dep
	-$(RM) package/cfg/atlas_temp_probe_pem4.c
	-$(RM) package/cfg/atlas_temp_probe_pem4.xdc.inc

clean,em4::
	-$(RM) atlas_temp_probe.pem4
.executables,em4 .executables: atlas_temp_probe.xem4

atlas_temp_probe.xem4: |atlas_temp_probe.pem4

-include package/cfg/atlas_temp_probe.xem4.mak
atlas_temp_probe.xem4: package/cfg/atlas_temp_probe_pem4.oem4 
	$(RM) $@
	@$(MSG) lnkem4 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/atlas_temp_probe_pem4.oem4   package/cfg/atlas_temp_probe_pem4.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4.rootDir)/lib/libc.a
	
atlas_temp_probe.xem4: export C_DIR=
atlas_temp_probe.xem4: PATH:=$(ti.targets.arm.elf.M4.rootDir)/bin/;$(PATH)
atlas_temp_probe.xem4: Path:=$(ti.targets.arm.elf.M4.rootDir)/bin/;$(PATH)

atlas_temp_probe.test test,em4 test: atlas_temp_probe.xem4.test

atlas_temp_probe.xem4.test:: atlas_temp_probe.xem4
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 atlas_temp_probe.xem4.test
else
	@$(MSG) running $<  ...
	$(call EXEC.atlas_temp_probe.xem4, ) 
endif

clean,em4::
	-$(RM) $(wildcard .tmp,atlas_temp_probe.xem4,*)


clean:: clean,em4

clean,em4::
	-$(RM) atlas_temp_probe.xem4
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
atlas_temp_probe_pem4.oem4,copy : package/cfg/atlas_temp_probe_pem4.oem4
atlas_temp_probe_pem4.sem4,copy : package/cfg/atlas_temp_probe_pem4.sem4

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_atlas_temp_probe
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_atlas_temp_probe.tar.dep
endif
package/rel/xconfig_atlas_temp_probe/xconfig_atlas_temp_probe/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_atlas_temp_probe/xconfig_atlas_temp_probe/package/package.rel.xml: package/build.cfg
package/rel/xconfig_atlas_temp_probe/xconfig_atlas_temp_probe/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_atlas_temp_probe/xconfig_atlas_temp_probe/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_atlas_temp_probe.tar: package/rel/xconfig_atlas_temp_probe.xdc.inc package/rel/xconfig_atlas_temp_probe/xconfig_atlas_temp_probe/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_atlas_temp_probe.xdc.inc,package/rel/xconfig_atlas_temp_probe.tar.dep)


release release,xconfig_atlas_temp_probe: all xconfig_atlas_temp_probe.tar
clean:: .clean
	-$(RM) xconfig_atlas_temp_probe.tar
	-$(RM) package/rel/xconfig_atlas_temp_probe.xdc.inc
	-$(RM) package/rel/xconfig_atlas_temp_probe.tar.dep
